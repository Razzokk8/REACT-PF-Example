...
const Banner = () => (
    <Parallax 
    blur={{ min: -15, max: 15 }}
    className="bannerWeb" style={{height:"100vh"}} bgImage="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80" bgImageAlt="the cat" strength={500}>

<div className='container-fluid d-flex justify-content-center align-items-center flex-column'>
                <div className="col-md-12 container-fluid mt-3 bannerWebContent">
			  <div className="row">
        <h2 className='align-start text-muted mb-4 mt-3 d-flex align-items-center'><i className="medium material-icons me-1">language</i>Web</h2>
