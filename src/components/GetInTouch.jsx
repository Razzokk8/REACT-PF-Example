...
function GetInTouch() {
    return (
        ...
        <blockquote class="blockquote">
            ...
            <div className='nav-item d-flex justify-content-between mb-5 mt-5 align-items-center' style={{maxWidth: "380px", margin: "0 auto", height:"50px"}}>
            ...
            <div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="66px"  fill="currentColor" className="bi bi-envelope envelopeH" viewBox="0 0 16 16">
