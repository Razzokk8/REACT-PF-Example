...
function MusicCards() {
    ...
    return (
        ...
        <div className="card 1">
          <div className="card_image"><img src={database} alt='database-album-cover'/></div>
{/*           <div className="card_title title-white">
        ...
        <a href='https://ghostly.bandcamp.com/track/inferno' target='_blank' rel="noreferrer">
        ...
        <a href='https://indexmarcelfengler.bandcamp.com/track/speed' target='_blank' rel="noreferrer">
