    ...
    <div id="folderC" className="d-flex justify-content-center">
      <div className="background">
        <div className="file" onClick={toggleClass}>
          <a href="https://razzokk8.github.io/FCC.Technical-Documentation-Page/" target="_blank" rel="noreferrer">
            <div className="page box1">
              <h4>Item 1</h4>
            </div>
          </a>
          <a href="https://omdb-api-react-my-movies.herokuapp.com" target="_blank" rel="noreferrer">
            <div className="page box2">
              <h4>Item 2</h4>
            </div>
          </a>
          <a href="https://virtual-bookshell.herokuapp.com" target="_blank" rel="noreferrer">
