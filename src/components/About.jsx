...
function About() {
  ...
  <div id='about'>
      ...
      <i className="small text-muted material-icons mb-2">language</i>FULL-STACK<br/>DEVELOPER</h5>

      <h5 className='text-primary d-flex align-items-center mb-0 row justify-content-center'>
      <i className="small text-muted material-icons mb-2">brush</i>UX/UI GRAPHIC<br/>& WEB DESIGNER</h5>

      <h5 className='text-primary d-flex align-items-center mb-0 row justify-content-center'>
      <i className="small text-muted material-icons mb-2">audiotrack</i>MUSIC<br />PRODUCER</h5> 
      </div>
          </div>
          {/*Waves Container*/}
          <div>
